...
| --- | --- |
| ASU Devils Invent event-cover image | Event name, theme, and Honeywell sponsorship. |
| Challenge-brief image | Robotics and automation challenge; automated material handling as the stated context. |
...
The media supports the following physical observations:

- A wheeled base carrying a battery pack, breadboarded electronics, and microcontroller hardware.
- A horizontal lead screw with a stepper motor and guide rods.
- A vertical linear-motion assembly.
- Servo-actuated linkages and a rapid-fabricated handling structure.
- A bench-level motion demonstration in a mocked factory-cell setup.

## Proposed, not validated here

The team presentation also described chamber opening, vacuuming of excess powder, printed-part extraction, computer-vision monitoring, and dashboard logging. These are documented as the **design intent**. The supplied archive does not establish that the following were completed or measured:

- Handling of real metal powder or a real LPBF build.
